...
<div class="navbar">
  ...
  <a class="active" href="home.php"><i class="fa fa-fw fa-home"></i> Home</a>
    ...
    margin-top: -50px;border:3px solid;" type="text" placeholder="Enter Location" name="location" required>
                    ...
                    <input  style="width:200px; margin-top:-50px; border:3px solid;margin-left: 100px;" type="date" name="date" required>
                    <br>
                    <br>
                    <label  style="width:100px; margin-top:70px;" for="time"><h2><b>Time</h2></b></label>
                    <input  style="width:200px; margin-top:-100px;border:3px solid;margin-left: 100px;" type="time" placeholder="enter time" name="time" required>
<br>
<br>
...
<div class="form-popup" id="form">
  ...
  <label for="username"><b>Hii Username</b></label>
<br>
<br>
...
while($row=mysqli_fetch_array($qrun)){
  ...
  margin: 3px 0 22px 0;
  border: none;
  background: #f1f1f1; margin-top:660px;position:fixed; right: 28px;
